...
console.log(notcoming, "you can't make for dinner.");
...
guestList.forEach(function (oneguest) { return console.log("Hi My Dear: ".concat(oneguest, ", would you like to dinner with me.")); });
