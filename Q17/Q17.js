...
// creating a Array.
var guestList = ["Ayesha", "Komal", "Eman", "Shanzy"];
...
console.log("Unfortunately, the new dinner table is not available on a time, so i can invite only two guests to dinner with me.");
...
guestList.forEach(function (lastTwo) { return console.log("luckily ".concat(lastTwo, " you are still invited for a dinner.")); });
